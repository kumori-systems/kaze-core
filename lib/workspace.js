...
class ExtendedRegistrationResult extends stamp_manager_1.RegistrationResult {
}
exports.ExtendedRegistrationResult = ExtendedRegistrationResult;
class Workspace {
    ...
    deploy(paths, stamp) {
        return deploy_1.deployCommand(paths, stamp, this.stamp);
    }
    /**
    ...
    info(requestedInfo, stamp) {
        return info_1.infoCommand(requestedInfo, stamp, this.stamp);
    }
    init(template) {
        return initialize_1.initCommand(template);
    }
    register(paths, stamp) {
        return register_1.registerCommand(paths, stamp, this.stamp);
    }
    undeploy(uris, stamp) {
