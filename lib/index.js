...
exports.workspace = new workspace_1.Workspace(new component_1.Component(), new deployment_1.Deployment(), new localstamp_1.LocalStamp(), new runtime_1.Runtime(), new service_1.Service(), new resource_1.Resource(), new project_1.Project(), new stamp_1.Stamp());
